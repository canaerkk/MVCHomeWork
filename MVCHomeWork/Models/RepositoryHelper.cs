namespace MVCHomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static View_1Repository GetView_1Repository()
		{
			var repository = new View_1Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static View_1Repository GetView_1Repository(IUnitOfWork unitOfWork)
		{
			var repository = new View_1Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
